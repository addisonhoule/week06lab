...
//		Game Loop 
		while (winner.equals("") && totalSquares <=9) {
		 ...
		 } else if (winner.equals(player1.getxOrO())) {
			 System.out.println("Hot dog, " + player1.getPlayer() + "! You win!");
		 } else {
			 System.out.println("That's some good triple t-ing " + player2.getPlayer() + "!");
		 }
